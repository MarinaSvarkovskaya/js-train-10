...
function extendAndFreezeObject(obj1, obj2) {
  ...
  if (Object.isFrozen(a)) {
    console.log(`об'єкт заморожено`);
  } else console.log(`об'єкт не було заморожено`);
  return a;
}
...
function filterObjectsByKey(arr, key) {
  ...
  let a = arr.filter((i) => i.hasOwnProperty(key));
  return a;
}
...
function checkOwnership(obj1, obj2, key) {
  ...
  let a = obj1.hasOwnProperty(key);
  console.log(a);
  let b = obj2.hasOwnProperty(key);
  console.log(b);
  if (a === b) {
    console.log(`true`);
  } else return `false`;
